...
('WITHDRAWAL', 104, N'Yêu cầu rút 50.000.000 VND', N'Khoản rút lớn. Cần AUD soát xét và FIN chi.', 'PENDING', 'AUD,FIN', NULL, GETDATE(), GETDATE()),
...
('DISPUTE_REFUND', 204, N'Tranh chấp thiết kế Logo', N'Client bảo logo copy trên mạng. Cần AUD check bản quyền.', 'PENDING', 'AUD,DIS', NULL, GETDATE(), GETDATE()),
...
('DISPUTE_REFUND', 207, N'Freelancer giao source code rỗng', N'Khách hàng báo cáo file zip trống.', 'IN_PROGRESS', 'AUD', 'admin@gmail.com', GETDATE(), GETDATE()),
...
INSERT INTO department_verification_tasks (task_type, reference_id, title, description, status, required_departments, assigned_to_email, created_at, updated_at) VALUES 
('KYC_VERIFICATION', 301, N'Xác thực Doanh Nghiệp FPT', N'Yêu cầu cấp tick xanh doanh nghiệp.', 'PENDING', 'MOD,AUD', NULL, GETDATE(), GETDATE()),
...
('KYC_VERIFICATION', 304, N'Xác thực Agency nước ngoài', N'Công ty Mỹ đăng ký, cần check Legal.', 'PENDING', 'AUD', NULL, GETDATE(), GETDATE()),
...
('KYC_VERIFICATION', 307, N'Xác thực Doanh Nghiệp VNPT', N'Cần check giấy đăng ký kinh doanh.', 'PENDING', 'AUD', NULL, GETDATE(), GETDATE()),
('KYC_VERIFICATION', 308, N'Tài khoản trùng IP', N'Phát hiện 5 acc đăng ký chung 1 máy.', 'PENDING', 'AUD', NULL, GETDATE(), GETDATE()),
...
INSERT INTO department_verification_tasks (task_type, reference_id, title, description, status, required_departments, assigned_to_email, created_at, updated_at) VALUES 
('FRAUD_ALERT', 401, N'Cảnh báo rửa tiền', N'Giao dịch 500tr chuyển vào và rút ra ngay lập tức.', 'PENDING', 'AUD,FIN', NULL, GETDATE(), GETDATE()),
('FRAUD_ALERT', 402, N'Hack tài khoản', N'Login từ IP Nga, thay đổi email và đổi pass liên tục.', 'IN_PROGRESS', 'AUD', 'admin@gmail.com', GETDATE(), GETDATE()),
('FRAUD_ALERT', 403, N'Gian lận review', N'Cùng 1 máy tính tạo 10 acc clone để tự đánh giá 5 sao.', 'PENDING', 'AUD', NULL, GETDATE(), GETDATE()),
('FRAUD_ALERT', 404, N'Spam link lừa đảo', N'Freelancer gửi link phishing cho hàng loạt Client.', 'PENDING', 'AUD,CS', NULL, GETDATE(), GETDATE()),
('FRAUD_ALERT', 405, N'Đánh cắp Source Code', N'Report freelancer copy code dự án bán cho người khác.', 'PENDING', 'DIS,AUD', NULL, GETDATE(), GETDATE()),
('FRAUD_ALERT', 406, N'Thẻ tín dụng bị trộm', N'Ngân hàng báo cáo chargeback từ thẻ ăn cắp.', 'PENDING', 'FIN', NULL, GETDATE(), GETDATE()),
('FRAUD_ALERT', 407, N'Gian lận Affiliate', N'Tự ref link đăng ký nhận hoa hồng ảo.', 'PENDING', 'AUD', NULL, GETDATE(), GETDATE()),
('FRAUD_ALERT', 408, N'Đe dọa tống tiền', N'Freelancer dọa xóa database nếu không chuyển thêm tiền.', 'PENDING', 'AUD,CS', NULL, GETDATE(), GETDATE()),
('FRAUD_ALERT', 409, N'Giả mạo nhân viên sàn', N'User giả danh admin để xin password.', 'PENDING', 'AUD', NULL, GETDATE(), GETDATE()),
('FRAUD_ALERT', 410, N'Bot click tự động', N'Nghi ngờ dùng bot quét dữ liệu nền tảng.', 'PENDING', 'AUD', NULL, GETDATE(), GETDATE());

-- Thêm 10 công việc kháng cáo tài khoản (ACCOUNT_APPEAL)
INSERT INTO department_verification_tasks (task_type, reference_id, title, description, status, required_departments, assigned_to_email, created_at, updated_at) VALUES 
('ACCOUNT_APPEAL', 501, N'Xin mở khóa tài khoản HieuPC', N'Bị ban nhầm vì IP trùng, yêu cầu xem xét lại.', 'PENDING', 'AUD', NULL, GETDATE(), GETDATE()),
...
('ACCOUNT_APPEAL', 508, N'Khôi phục Portfolio bị xóa', N'Dự án mẫu bị xóa do vi phạm bản quyền, xin cung cấp bằng chứng.', 'PENDING', 'AUD', NULL, GETDATE(), GETDATE()),

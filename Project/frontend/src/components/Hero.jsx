          ...
          <button
            ...
            onClick={() => {
              if (onNavigate) {
                ...
                if (findWorkSection) findWorkSection.scrollIntoView({ behavior: 'smooth' });
              }
            }}
            className={`${user?.role === 'FREELANCER' ? 'bg-secondary hover:bg-secondary-dark px-10 text-lg shadow-secondary/20' : 'bg-primary hover:bg-primary-light shadow-primary/10'} text-white px-8 py-4 rounded-xl font-bold text-body-md transition-all duration-200 shadow-lg hover:scale-[1.02] active:scale-[0.98]`}
          >
            Tìm việc làm / Dự án
          </button>

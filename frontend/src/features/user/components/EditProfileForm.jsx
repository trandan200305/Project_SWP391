        ...
        {(role === 'freelancer' || role === 'employer') && (
          <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
            ...
            <textarea
              ...
              className="w-full text-sm text-gray-900 font-medium leading-relaxed border border-gray-200 focus:border-blue-500 rounded-lg p-3 resize-none transition-all outline-none min-h-[120px]"
            />
          </div>
        )}
